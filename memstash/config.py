...
class Config:
    ...
    firewall_mode: str = "quarantine"      # write firewall: "quarantine" | "warn" | "off"
    firewall_trusted_sources: str = "manual,auto"  # sources that bypass the firewall (comma-separated)
